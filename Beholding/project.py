...
class Project:
    ...
    def read_command(self):
        ...
        try:
            command_record = statement.read_json(record_file)
        except IOError:
    ...
    def record_command(self, command_record):
        ...
        statement.write_json(command_record, self.path('last-command'))
    ...
    def record_output_changes(self):
        if self.option('do-record-outputs'):
            ...
            statement.write_json(self._output_changes, self.path('output-changes'))
    ...
    def read_output_changes(self):
        if self.option('do-record-outputs'):
            ...
            try:
                output_changes = statement.read_json(changes_file)
            except IOError:
